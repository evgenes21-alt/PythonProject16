...
class Category:
    ...
    total_categories: int = 0  # Количество созданных категорий
    total_products: int = 0  # Общее количество товаров во всех категориях
    ...
    def __init__(self,name: str ,description: str, products: list[Product]):
        ...
        # Автоматически увеличиваем счётчик категорий
    ...
    def remove_product(self, product: Product):
        """
        Удаляет товар из категории и уменьшает общий счётчик товаров.
        """
